...
import de.learnlib.api.logging.*;
 ...
 * @author falkhowar
 */
public class MyLearnLogger extends Logger {

    private MyLearnLogger(String name) {
        super(name, null);
    }
     ...
     * @return
     */
    public static MyLearnLogger getLogger(String name) {
        LogManager m = LogManager.getLogManager();
        Logger log = m.getLogger(name);
        if (log == null) {
            log = new MyLearnLogger(name);
            m.addLogger(log);
        }
        return (MyLearnLogger) log;
    }
     ...
     */
    public static MyLearnLogger getLogger(Class<?> clazz) {
