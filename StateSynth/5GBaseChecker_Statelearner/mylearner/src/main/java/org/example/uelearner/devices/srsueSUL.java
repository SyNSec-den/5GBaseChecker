...
public class srsueSUL extends DeviceSUL {
    public srsueSUL(UESUL uesul) {
        super(uesul);
    }
    ...
    public void pre() {
        ...
        try{
            ...
            System.out.println("srsuesul line 35");
        }
...
//            sendToTelegram("May be connection refused handled!");
    ...
    public void post() {
        ...
        try{
            uesul.amf_socket.setSoTimeout(1000);
    ...
    public String step(String symbol) {
        ...
        try {
            ...
            if (symbol.startsWith("enable_s1")) {
            ...
            } else if (symbol.startsWith("registration_reject")) {
                rrc_amf = 1;
                System.out.println("Log executor: sending registration_reject.");
                uesul.amf_socket.setSoTimeout(socket_wait_time);
                uesul.amf_out.write(symbol + "\n");
                uesul.amf_out.flush();
                ...
                uesul.amf_socket.setSoTimeout(socket_wait_time);
                uesul.amf_out.write("registration_accept_h4_plain_text" + "\n");
                uesul.amf_out.flush();
