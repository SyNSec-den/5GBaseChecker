...
/* most thread variable and functions
 * are defined in Macro
 * are actually pthread variable and functions
 */
...
typedef struct ogs_thread_s {
    ogs_thread_id_t id;          // pthread_t

    ogs_thread_mutex_t mutex;    // pthread_mutex_t
    ogs_thread_cond_t cond;      // pthread_condt
...
#if !defined(_WIN32)   // linux, using pthread
