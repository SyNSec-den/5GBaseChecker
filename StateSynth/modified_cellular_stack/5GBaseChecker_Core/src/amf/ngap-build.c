...
{
    ogs_info("enter ngap_build_request");
    int i;
    ...
    *RAN_UE_NGAP_ID = ran_ue->ran_ue_ngap_id;
    ...
    ogs_info("num of nssai = %d",amf_ue->allowed_nssai.num_of_s_nssai);
    ogs_assert(amf_ue->allowed_nssai.num_of_s_nssai); // comment this??
    for (i = 0; i < amf_ue->allowed_nssai.num_of_s_nssai; i++) {
        NGAP_AllowedNSSAI_Item_t *NGAP_AllowedNSSAI_Item = NULL;
        NGAP_S_NSSAI_t *s_NSSAI = NULL;
        NGAP_SST_t *sST = NULL;
