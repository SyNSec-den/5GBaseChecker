...
{
    ogs_info("enter ausf_state_initial");
    ausf_sm_debug(e);
...
{
    //ogs_info("enter ausf_state_operational");
    int rv;
    ...
    case OGS_EVENT_SBI_SERVER:
        ogs_info("enter ogs_event_sbi_server");
        ...
        CASE(OGS_SBI_SERVICE_NAME_NAUSF_AUTH)
            SWITCH(message.h.method)
            CASE(OGS_SBI_HTTP_METHOD_POST)
                ogs_info("enter ausf-sm nausf_auth post");
            ...
            CASE(OGS_SBI_HTTP_METHOD_PUT)
                ogs_info("enter ausf-sm nausf_auth put");
