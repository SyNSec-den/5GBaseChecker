...
if __name__ == "__main__":
    ...
    parser.add_argument('-lts1', dest='lts1_dot_file', default="FSM/Redmagic.dot", help="BLE FSM 1")
    parser.add_argument('-lts2', dest='lts2_dot_file', default="FSM/Hisense.dot",
                        help="BLE FSM 2")
